...
\section{Spiegazione teorica del problema - Esercizio A}
...
\item \textbf{BinaryTree}
    \begin{itemize}
        ...
        \item \textbf{node_read} : contarore che tiene nota di quante letture vengono fatte sull'albero.
        \item \textbf{node_written} : contarore che tiene nota di quante scritture vengono fatte sull'albero.
    \end{itemize}
...
\item \textbf{BTree}
    \begin{itemize}
        ...
        \item \textbf{node_read} : contarore che tiene nota di quante letture vengono fatte sull'albero \textit{p}.
        \item \textbf{node_written} : contarore che tiene nota di quante scritture vengono fatte sull'albero\textit{p}.
    \end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{crandom_array(n)} : restituisce un'array ordinato casualmente con n valori da 1 a n.
        ...
        \item \textbf{draw_side_graphs(left_data, right_data, plot_title, filename)} : genera due grafici l'uno accanto all'altro, e salva il tutto in memoria con il nome filename.
...
\newpage
\section{Descrizione degli esperimenti condotti e analisi dei risultati sperimentali - Esercizio A}
...
\subsubsection{Alberi a confronto con $t=250$}
...
\subsubsection{Alberi a confronto con t = 1000}
...
\subsubsection{Alberi a confronto con $t = 1009$}
